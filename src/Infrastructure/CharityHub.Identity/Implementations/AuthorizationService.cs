...
namespace CharityHub.Identity.Implementations
{
    public class AuthorizationService : IAuthorizationService
    {
        ...
        #region Constructors
        public AuthorizationService(RoleManager<Role> roleManager, UserManager<Account> userManager,
        ...
        public async Task<ManageUserRolesResponse> GetManagerAccountsRolesData(Account user)
        {
            try
            {
            ...
            {
                _logger.LogDebug(ex, "Error in GetManagerAccountsRolesData");
                throw;
            }
        }
