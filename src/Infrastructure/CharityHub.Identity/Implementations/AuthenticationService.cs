...
namespace CharityHub.Identity.Implementations
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public AuthenticationService(JwtSettings jwtSettings, IDeviceService deviceRepository,ILoggerManager logger)
        {       
        ...
        public async Task<JwtAuthResponse> GetJwtToken(Account user)
        {
            try
            {
                ...
                await _deviceRepository.CreateDeviceAsync(userdeviceToken);
        ...
        private List<Claim> GetClaims(Account user, List<string> roles)
        {
